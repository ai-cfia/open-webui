		...
		<div class="{transparentBackground ? 'bg-transparent' : 'bg-white dark:bg-gray-900'} ">
			...
			>
				<div class="">
					...
					<div class="my-2 p-2 bg-yellow-200 text-yellow-800 rounded text-center text-sm">
						Do not include any protected, private, or sensitive information. Responses might be inaccurate | <a href="https://www.canada.ca/en/government/system/digital-government/digital-government-innovations/responsible-use-ai/guide-use-generative-ai.html" target="_blank" rel="noopener noreferrer" class="underline">Follow TBS Guidelines</a> |
						<a href="#" role="button" class="underline font-medium" on:click|preventDefault={() => showTermsModal = true}>
							Terms of service
						</a>
					</div>
					<!-- END BANNER -->
	...
	<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50" on:click|self={() => showTermsModal = false}>
		<div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl max-w-lg w-full m-4" on:click|stopPropagation>
			...
			<div class="text-gray-700 dark:text-gray-300 space-y-2 max-h-[60vh] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-gray-100 dark:scrollbar-track-gray-700 text-left">
				...
				<p><strong>Prohibition on Sensitive Information:</strong> Users are strictly prohibited from using any sensitive or protected information when interacting with the AMI app.</p>
				<p><strong>Intended Use:</strong> AMI is designed to be a productivity tool and should not be used as a replacement for human intelligence and judgment. Users are responsible for verifying the accuracy of the outputs generated by the app.</p>
				<p><strong>Experimental Release:</strong> AMI is currently in an experimental release phase under development. As such, there are no guarantees regarding its performance or reliability during this trial period.</p>
				<p><strong>Values and Ethics:</strong> Usage of AMI is subject to the Values and Ethics Code for the Public Sector. Users must ensure that their interactions with the app align with the ethical standards and values expected of public sector employees.</p>
				<p><strong>Revocation of Access:</strong> Failure to comply with the above terms may result in the revocation of access to the AMI app.</p>

				<h3 class="text-lg font-semibold mt-6 mb-2 text-gray-800 dark:text-gray-200">Conditions d'utilisation de AMI</h3>
				<p><strong>Conformité aux directives:</strong> Tous les utilisateurs doivent se conformer aux directives du Secrétariat du Conseil du Trésor (SCT) sur l'utilisation de l'IA générative dans la fonction publique.</p>
				<p><strong>Interdiction des informations sensibles:</strong> Les utilisateurs sont strictement interdits d'utiliser des informations sensibles ou protégées lors de l'interaction avec l'application AMI.</p>
				<p><strong>Utilisation prévue:</strong> AMI est conçu pour être un outil de productivité et ne doit pas être utilisé comme un substitut à l'intelligence et au jugement humains. Les utilisateurs sont responsables de vérifier l'exactitude des résultats générés par l'application.</p>
				<p><strong>Version expérimentale:</strong> AMI est actuellement en phase de version expérimentale en cours de développement. En tant que tel, il n'y a aucune garantie quant à ses performances ou sa fiabilité pendant cette période d'essai.</p>
				<p><strong>Valeurs et éthique:</strong> L'utilisation de AMI est soumise au Code de valeurs et d'éthique du secteur public. Les utilisateurs doivent s'assurer que leurs interactions avec l'application sont conformes aux normes éthiques et aux valeurs attendues des employés du secteur public.</p>
				<p><strong>Révocation de l'accès:</strong> Le non-respect des conditions ci-dessus peut entraîner la révocation de l'accès à l'application AMI.</p>
				<!-- End terms of service content -->
			</div>
			<div class="mt-6 flex justify-end">
				<button
					type="button"
					class="px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-100 rounded hover:bg-gray-300 dark:hover:bg-gray-500 transition"
					on:click={() => showTermsModal = false}
				>
					Close
				</button>
